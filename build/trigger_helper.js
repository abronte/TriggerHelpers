...
(function() {
  var Display, Event, Logger, Notification, Platform, Prefs, Request, isTrigger, root, _base, _base1, _nextTick, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
  ...
  Prefs = (function() {
    ...
    Prefs.prototype.keys = function(callback) {
      var i, key, keys, _i, _ref7;

      keys = [];
      for (i = _i = 0, _ref7 = localStorage.length - 1; 0 <= _ref7 ? _i <= _ref7 : _i >= _ref7; i = 0 <= _ref7 ? ++_i : --_i) {
