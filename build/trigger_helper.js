...
(function() {
  var Display, Event, Logger, Notification, Prefs, Request, isTrigger, root, _base, _base1, _nextTick, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
  ...
  Logger = (function() {
    ...
    function Logger() {
      var level, methodName, name, _ref4;

      this.logLevel = 5;
      for (name in LEVELS) {
        _ref4 = LEVELS[name], level = _ref4.level, methodName = _ref4.methodName;
  ...
  if ((_ref5 = root.notification) == null) {
  ...
  Prefs = (function() {
    ...
    Prefs.prototype.keys = function(callback) {
      var i, key, keys, _i, _ref6;

      keys = [];
      for (i = _i = 0, _ref6 = localStorage.length - 1; 0 <= _ref6 ? _i <= _ref6 : _i >= _ref6; i = 0 <= _ref6 ? ++_i : --_i) {
